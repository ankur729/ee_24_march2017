...
console.log(req.body.banner_info.banner_name);
var update_id=req.body.banner_info._id
console.log(update_id);
        ...
        db.admin_infos.findAndModify(
                                        ...
                                        {'banner_info._id':mongojs.ObjectId(update_id) },
                                          {  $set: 
                                                         { "banner_info.banner_name":req.body.banner_info.banner_name, 'banner_status':req.body.banner_info.banner_status ,
